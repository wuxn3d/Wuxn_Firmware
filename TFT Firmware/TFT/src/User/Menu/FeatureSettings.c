...
LISTITEM settingPage[SKEY_COUNT] = {
  ...
  {ICONCHAR_TOGGLE_ON,   LIST_TOGGLE,        LABEL_ENABLE_OOBWCW,          LABEL_BACKGROUND},
...
void updateFeatureSettings(uint8_t key_val)
{
  ...
  switch (item_index)
  {
    ...
    case SKEY_ENABLE_OOBWCW:
      infoSettings.enable_oobwcw = (infoSettings.enable_oobwcw + 1) % ITEM_TOGGLE_NUM;
      settingPage[item_index].icon = iconToggle[infoSettings.enable_oobwcw];
      break;
