...
#define CONFIG_VERSION 20220626

// WUXN
#define  WUXN_CODE  // enable the WUXN features/customizations/skinning etc.
...
//061622 #define PREHEAT_LABELS   {"PLA", "PETG", "ABS", "WOOD", "TPU", "NYLON"}
//061622#define PREHEAT_HOTEND   {200,   240,    230,   170,    220,   250}
//061622#define PREHEAT_BED      {60,    70,     90,    50,     50,    90}

//061822 - New profiles  NOTE: When changing, also change in config.ini
#define PREHEAT_LABELS   {"PLA", "PETG", "ASA", "ABS", "TPU", "NYLON"} // 062822,  "PC"}  //061822
#define PREHEAT_HOTEND   {210,   250,     260,   255,    220,   250}  // 062822,    275}  //061822
#define PREHEAT_BED      {60,    85,     105,    100,     50,    90}  // 062822,    110}  //0618622

//062722 #define HEAT_MAX_TEMP    {275,       275,       275,       275,       275,       275,       150,    60}

#define HEAT_MAX_TEMP    {275,       275,       275,       275,       275,       275,       125,    60}
#define HEAT_SIGN_ID     {"T0:",     "T1:",     "T2:",     "T3:",     "T4:",     "T5:",     "B:",   "C:"}
#define HEAT_DISPLAY_ID  {"Nz" ,      "T1",      "T2",      "T3",      "T4",      "T5",      "Bed",  "Chamber"}
...
#define FAN_DISPLAY_ID   {     "Fan",      "F1",      "F2",      "F3",      "F4",      "F5",     "CtL",     "CtI" };
...
// 071222  #define NOZZLE_PAUSE_Y_POSITION     (Y_MIN_POS + 10)  // (mm) Must be an integer
#define NOZZLE_PAUSE_Y_POSITION     (Y_MAX_POS - 10)  // 071222 Issue 31  (mm) Must be an integer
...
// PID autotune
// 011822 change C15 to C5 for E0 and E-1 #define PID_CMD {"M303 U1 C15 E0", "M303 U1 C8 E1", "M303 U1 C8 E2", "M303 U1 C8 E3", "M303 U1 C8 E4", "M303 U1 C8 E5", "M303 U1 C15 E-1", ""};
#define PID_CMD {"M303 U1 C5 E0", "M303 U1 C8 E1", "M303 U1 C8 E2", "M303 U1 C8 E3", "M303 U1 C8 E4", "M303 U1 C8 E5", "M303 U1 C5 E-1", ""};
...
#define LCD_DIM_CUSTOM_SECONDS (15 * 60)  // Custom value in seconds. This will be used if DEFAULT_LCD_IDLE_TIMER
