...
#include "menu.h"
  ...
  #define LCD_DIM_OFF         0    
  #define LCD_DIM_5_SECONDS   5    
  #define LCD_DIM_10_SECONDS  10   
  #define LCD_DIM_30_SECONDS  30   
  #define LCD_DIM_60_SECONDS  60   
  #define LCD_DIM_120_SECONDS 120  
  #define LCD_DIM_300_SECONDS 300  
  /*
