...
#define SSD_HOR_RESOLUTION LCD_WIDTH   
#define SSD_VER_RESOLUTION LCD_HEIGHT  
...
void LCD_init_RGB(void)
{
  ...
  LCD_WR_REG(0x01);   
  Delay_ms(100);
  LCDC_FPR = (SSD_DCLK_FREQUENCY * 1048576) / 120 -1;  
  LCD_WR_REG(0xE6);   
