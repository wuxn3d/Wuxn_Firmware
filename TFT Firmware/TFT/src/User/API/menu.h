...
#define MENU_RECT_COUNT   (ITEM_PER_PAGE * 2 + 1)      
#ifdef WUXN_CODE
#define SS_RECT_COUNT     (ITEM_PER_PAGE * 2 + 1 + 1 + 1)  
#else
#define SS_RECT_COUNT     (ITEM_PER_PAGE * 2 + 1 + 1)  
#endif
#define TM_RECT_COUNT     (ITEM_PER_PAGE * 2 + 1 + 1)  
